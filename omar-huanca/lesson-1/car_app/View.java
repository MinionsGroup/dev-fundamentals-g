...
public class View {
    ...
    private void testPerformaceMenu() {
        ...
        System.out.println("=WINNER= " + winner.getCarName() + " =WINNER=");
    ...
    private void addCarMenu() {
        ...
        while (index != 0) {
            ...
            System.out.println("Name: " + newCar.getCarName());
    ...
    public void showList() {
        carsList.forEach(car -> System.out.println(car.getCarName() + " Gasoline: " + car.getGasoline() + " Tank size: " + car.getGasCapacity()));
    }
    ...
    public Car startPerformanceTest(double distance) {
        // moving distance
        carsList.forEach(car -> car.move(distance));
        // comparing gasoline
    ...
    public void showPerformanceList() {
        carsList.forEach(car -> {
            ...
            System.out.println("Gasoline per KM: " + car.getGasComsumption() + " [L]");
            if (state) {
                System.out.println("Actual Gasoline: " + car.getGasoline() + " [L]");
            } else {
                System.out.println("Actual Gasoline: 0");
            }
            System.out.println("Tank Limit: " + car.getGasCapacity() + " [L]");
            System.out.println("====================================");
        });
    }
    ...
    public Car createNewCar(String carName) {
        ...
        newCar.setGasoline(newCar.getGasCapacity());
        return newCar;
    }
