...
class CarBehavior {
    ...
    void addFuel(Car car, double fuel){
        if(car.fuelCapacity < fuel){
            ...
            if (car.fuelCapacity < car.fuel){
                ...
                System.out.println(car.name+": Added "+car.fuel+" liters");
                System.out.println(car.name+": Added "+car.maximumDistanceWithFullTank+" performance in Km");
            }
    ...
    void searchWin(double distance) {
    ...
    void addPerformanceInKm(){
        Scanner scanner = new Scanner(System.in);
        for (int i = 0; i < automobileCount; i++){
            System.out.println(automobile[i].name +": Add performance in Km");
            automobile[i].maximumDistanceWithFullTank = scanner.nextDouble();
        }
    }
}
